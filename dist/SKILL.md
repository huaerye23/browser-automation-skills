...
description: Browser automation skills for AI models — navigate, screenshot, interact, scrape, debug, test, and record browser sessions. Controls local Google Chrome via CDP. 浏览器自动化技能包，让 AI 模型控制本地 Chrome 浏览器。
---
...
```bash
# Start Chrome with debugging / 启动 Chrome 调试模式
